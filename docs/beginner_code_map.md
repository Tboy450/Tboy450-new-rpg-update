...
- `world.py`: 3x3 world layout, area descriptions, colors, draw-only scenic styles, low-alpha atmosphere overlays, regional music moods, particles, and environmental effects.
