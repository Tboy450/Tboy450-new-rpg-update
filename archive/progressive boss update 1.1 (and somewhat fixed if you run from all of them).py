...
class BattleScreen:
    ...
    def draw(self, surface):
        ...
        # Draw enemy
        if hasattr(self.enemy, 'enemy_type') and self.enemy.enemy_type.startswith("boss_dragon"):
        ...
        if not (hasattr(self.enemy, 'enemy_type') and self.enemy.enemy_type.startswith("boss_dragon")):
    ...
    def run(self):
        ...
        while running:
            ...
            if self.state == "start_menu":
                ...
                if battle_ended:
                    # Boss battle win
                    if hasattr(self.battle_screen.enemy, 'enemy_type') and (
                        self.battle_screen.enemy.enemy_type.startswith("boss_dragon") or self.battle_screen.enemy.enemy_type == "boss_dragon"):
