...
TOWN_INTERIORS = {
    "inn": {
        ...
        # BEGINNER NOTE: Imported NPC sprites use room rectangles so they can
        # be resized without editing the PNG. The Innkeeper is intentionally
        # small enough to sit behind the counter instead of filling the room.
        "npc_sprite_rect": (720, 300, 105, 140),
        ...
        "props": (
            ...
            {"kind": "counter", "rect": (670, 410, 190, 58), "color": (118, 66, 34), "sprite": "town_inn/tavern_bar_counter.png", "sprite_preserve_aspect": False},
            {"kind": "hearth", "rect": (445, 235, 105, 82), "color": (78, 48, 38), "sprite": "town_inn/hearth_fireplace.png"},
    ...
    "blacksmith": {
        ...
        # The large source PNG is still preserved in assets/processed/npcs/.
        "npc_sprite_rect": (705, 305, 126, 145),
        "npc_sprite_anchor": "bottom",
        "props": (
    ...
    "town_hall": {
        ...
        "props": (
            ...
            {"kind": "desk", "rect": (405, 392, 190, 86), "color": (88, 56, 36), "sprite": "town_hall/town_hall_dais.png"},
            {"kind": "notice", "rect": (625, 245, 120, 155), "color": (138, 104, 74), "sprite": "town_hall/notice_board.png"},
