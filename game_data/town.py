...
TOWN_BUILDINGS = (
    {
        ...
        "color": (200, 180, 160),
        "style": "grand",
        # BEGINNER NOTE: The town hall now uses an active transparent PNG
        # facade. The old Python-drawn columns/roof remain in `main.py` as a
        # fallback if the sprite ever fails to load.
        "sprite": "town_hall/town_hall_front.png",
        "sprite_rect": (370, 325, 260, 195),
